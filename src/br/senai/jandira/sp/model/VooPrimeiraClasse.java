...
public class VooPrimeiraClasse extends Voo {
    public VooPrimeiraClasse(String companhia, String destino, String origem, String hora, int pasageiros, int vooNumero) {
